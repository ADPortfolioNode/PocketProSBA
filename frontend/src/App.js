...
function App() {
  ...
  // --- SBA Resources: All SBA data must be loaded from API, not hardcoded ---
  // The resources array is always populated by fetchResources(), which calls the backend endpoint.
  // No hardcoded SBA resource data is present in this file. All resource JSON for frontend rendering
  // is generated by the SBA backend endpoint content.
