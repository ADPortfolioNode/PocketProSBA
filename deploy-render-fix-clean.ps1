...
git commit -m "fix: Update render.yaml to use static site deployment for frontend - Changed frontend from Node.js service to static site - Fixed 502 Bad Gateway errors for static assets - Updated build configuration for proper asset serving - Removed unnecessary PORT and startCommand for static site"
